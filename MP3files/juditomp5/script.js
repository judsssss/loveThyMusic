...
function loadMusic(indexNumb){
    ...
    musicImg.src = `/album/${allMusic[indexNumb - 1].img}.jpg`;
    mainAudio.src = `/audio/${allMusic[indexNumb - 1].scr}.mp3`; 
}
...
for (let i = 0; i < allMusic.length; i++) {
  ...
  liAudioTag.addEventListener("loadeddata", ()=>{
    ...
    liAudioDuartion.setAttribute("t-duration", `${totalMin}:${totalSec}`); //adding t-duration attribute with total duration value
  });
}
